...
public class CodeKeeperAboutBox extends javax.swing.JDialog {

    public CodeKeeperAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(codekeeper.CodeKeeperApp.class).getContext().getResourceMap(CodeKeeperAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(codekeeper.CodeKeeperApp.class).getContext().getActionMap(CodeKeeperAboutBox.class, this);
